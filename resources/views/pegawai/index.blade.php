            ...
            <div class="form-group">
                ...
                <select class="form-control btn-sm " name="unit" id = "unit" form="search">
                    ...
                    @foreach($units as $unit)
                        <option value="{{ $unit->id }}" {{ ($unit->id == $funit)? "selected" : "" }} >{{ $unit->unit }}</option>
                    @endforeach
                </select>
            </div>
&nbsp;&nbsp;
        ...
        <table class="table table-striped table-hover mx-auto" style="width: auto;">
            ...
            <tr>
                ...
                <td>
                        ...
                        <a href="{{ route('pegawai.create') }}" class="btn btn-primary float-center"></span><i class="fa-solid fa-address-book"></i> Tambah Pegawai </a>
                </td>
            </tr>
                    @endcan
            <tr>
            ...
            @foreach($pegawais as $key=>$pegawai)
                <tr>
                    ...
                    <td style="text-align: center;">
                        <img src="https://placehold.co/600x400/png" width="100" height="100" style="display: block; margin: 0 auto;" />
                    </td>
                    <td>
                        <div class="d-flex flex-column" style="padding-top: 5px;">
                            <div class="font-weight-bold mb-1">{{$pegawai->nama}}</div>
                            <div class="text-muted">
                                {{$pegawai->jawatan}} - Gred: {{$pegawai->gred}}<br>
                    ...
                    <td>
                        <div class="text-muted">
                            ...
                            @if( $pegawai->unit != null && $pegawai->unit != '-' )
                                <i class="fa-solid fa-building-circle-arrow-right"></i> UNIT : <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <small>{{$pegawai->unit}}</small>
                            @endif
                        </div>
